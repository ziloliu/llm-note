...
📄 [原文04: 串口通信协议基础](../raw/嵌入式开发/USART串口通信/04_串口通信协议基础.md)
...
📄 [原文05: UART与USART概念辨析](../raw/嵌入式开发/USART串口通信/05_UART与USART概念辨析.md)
...
📄 [原文06: USART功能框图详解](../raw/嵌入式开发/USART串口通信/06_USART功能框图详解.md)
...
📄 [原文07: USART波特率配置](../raw/嵌入式开发/USART串口通信/07_USART波特率配置.md)
...
📄 [原文08: USART寄存器配置](../raw/嵌入式开发/USART串口通信/08_USART寄存器配置.md)
...
📄 [原文09: USART1初始化代码实现](../raw/嵌入式开发/USART串口通信/09_USART1初始化代码实现.md)
...
📄 [原文10: USART1轮询方式收发](../raw/嵌入式开发/USART串口通信/10_USART1轮询方式收发.md)
...
📄 [原文11: USART1字符串收发](../raw/嵌入式开发/USART串口通信/11_USART1字符串收发.md)
...
📄 [原文12: USART1接收字符串实现](../raw/嵌入式开发/USART串口通信/12_USART1接收字符串实现.md)
...
📄 [原文13: IDLE标志位处理与改进](../raw/嵌入式开发/USART串口通信/13_IDLE标志位处理与改进.md)
...
📄 [原文14: IDLE标志位清除机制](../raw/嵌入式开发/USART串口通信/14_IDLE标志位清除机制.md)
...
📄 [原文15: 状态寄存器状态变化](../raw/嵌入式开发/USART串口通信/15_状态寄存器状态变化.md)
